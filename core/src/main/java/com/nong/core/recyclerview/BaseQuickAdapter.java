...
import com.patac.hmi.wiget.recyclerview.animation.AlphaInAnimation;
import com.patac.hmi.wiget.recyclerview.animation.BaseAnimation;
import com.patac.hmi.wiget.recyclerview.animation.ScaleInAnimation;
import com.patac.hmi.wiget.recyclerview.animation.SlideInBottomAnimation;
import com.patac.hmi.wiget.recyclerview.animation.SlideInLeftAnimation;
import com.patac.hmi.wiget.recyclerview.animation.SlideInRightAnimation;
import com.patac.hmi.wiget.recyclerview.entity.IExpandable;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case LOADING_VIEW:
                ...
                break;
            case HEADER_VIEW:
                baseViewHolder = new BaseViewHolder(mHeaderLayout,this);
                break;
            case EMPTY_VIEW:
                baseViewHolder = new BaseViewHolder(mEmptyView,this);
                break;
            case FOOTER_VIEW:
                baseViewHolder = new BaseViewHolder(mFooterLayout,this);
                break;
            default:
    ...
    private BaseViewHolder getLoadingView(ViewGroup parent) {
        if (mLoadingView == null) {
           throw new IllegalArgumentException("LoadingView is null");
            // return createBaseViewHolder(parent, R.layout.def_loading);
        }
        return new BaseViewHolder(mLoadingView,this);
    }
    ...
    protected BaseViewHolder createBaseViewHolder(ViewGroup parent, int layoutResId) {
        if (mContentView == null) {
            return new BaseViewHolder(getItemView(layoutResId, parent),this);
        }
        return new BaseViewHolder(mContentView,this);
    }
    ...
    public void showLoadMoreFailedView() {
        loadComplete();
        if (loadMoreFailedView == null) {
            throw new IllegalArgumentException("loadMoreFailedView is null");
