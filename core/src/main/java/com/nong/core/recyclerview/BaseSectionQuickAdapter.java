...
import com.patac.hmi.wiget.recyclerview.entity.SectionEntity;
...
public abstract class BaseSectionQuickAdapter<T extends SectionEntity> extends BaseQuickAdapter {
     ...
     */
    @Override
    protected void convert(BaseViewHolder holder, Object item, int positions) {
        switch (holder.getItemViewType()) {
            case SECTION_HEADER_VIEW:
                ...
                break;
            default:
                convert(holder, (T) item, positions);
                break;
        }
    }
