...
import com.nong.core.recycleview.decoration.DividerItemDecoration;
import com.nong.core.recycleview.decoration.SpaceItemDecoration;
...
public class RecyclerViewBuilder {
    ...
    public RecyclerViewBuilder setSpaceItemDecoration(int dimen, @DecorLayout int orientation){
        this.decor.add(new SpaceItemDecoration(dimen, orientation));
        return this;
    }
